 ...
 *
 * Agent-readable index of all 145 document templates organized by:
...
export const templates: Record<string, TemplateEntry> = {
  ...
  "external/04-diligence/cpa-tax-coordination-update": {
    id: "external/04-diligence/cpa-tax-coordination-update",
    name: "CPA tax coordination update",
    path: "./external/04-diligence/cpa-tax-coordination-update.html",
    pipeline: "external",
    stage: "04-diligence",
    audience: ["cpa"],
    status: "exists",
    ...
    isRequired: false,
    isRecurring: true,
    recurrenceRule: "during diligence",
    description:
      "Periodic update during diligence — QofE progress, tax election timing, document needs, and status of CPA-dependent items",
  },
  "internal/04-diligence/trustee-diligence-log": {
    id: "internal/04-diligence/trustee-diligence-log",
    name: "Trustee diligence log (internal)",
    path: "./internal/04-diligence/trustee-diligence-log.html",
    pipeline: "internal",
    stage: "04-diligence",
    audience: ["internal"],
    status: "exists",
    ...
    isRecurring: false,
    description:
      "Documents fiduciary process — prudent steps taken, independence confirmed, decisions made throughout diligence",
  },
  "external/04-diligence/counsel-legal-status-update": {
    id: "external/04-diligence/counsel-legal-status-update",
    name: "Counsel legal status update request",
    path: "./external/04-diligence/counsel-legal-status-update.html",
    pipeline: "external",
    stage: "04-diligence",
    audience: ["counsel"],
    status: "exists",
    ...
    isRecurring: false,
    description:
      "Proactive request for document drafting status, open legal issues, and timeline to Gate 4 legal clearance",
  },
  ...
  "external/06-post-close/cpa-post-close-tax-reminder": {
    id: "external/06-post-close/cpa-post-close-tax-reminder",
    name: "CPA post-close tax reminder",
    path: "./external/06-post-close/cpa-post-close-tax-reminder.html",
    pipeline: "external",
    stage: "06-post-close",
    audience: ["cpa"],
    status: "exists",
    ...
    recurrenceRule: "annually",
    description:
      "Year-end reminder: ESOP plan tax returns, §1042 election deadline, contribution timing, participant statements",
  },
  "external/06-post-close/broker-referral-nurture": {
    id: "external/06-post-close/broker-referral-nurture",
    name: "Broker referral nurture package",
    path: "./external/06-post-close/broker-referral-nurture.html",
    pipeline: "external",
    stage: "06-post-close",
    audience: ["broker"],
    status: "exists",
    ...
    isRecurring: false,
    description:
      "Anonymized closed-deal summary + testimonial request — reinforces referral relationship post-close",
  },
  "external/06-post-close/seller-exit-interview": {
    id: "external/06-post-close/seller-exit-interview",
    name: "Seller exit interview",
    path: "./external/06-post-close/seller-exit-interview.html",
    pipeline: "external",
    stage: "06-post-close",
    audience: ["seller"],
    status: "exists",
    ...
    isRecurring: false,
    description:
      "Post-COOP feedback on entire process — what worked, what didn't, NPS score, recommendation willingness",
  },
  "external/06-post-close/trustee-annual-review-agenda": {
    id: "external/06-post-close/trustee-annual-review-agenda",
    name: "Trustee annual review agenda",
    path: "./external/06-post-close/trustee-annual-review-agenda.html",
    pipeline: "external",
    stage: "06-post-close",
    audience: ["trustee"],
    status: "exists",
    ...
    recurrenceRule: "annually",
    description:
      "Annual meeting agenda: repurchase obligation status, valuation update, plan health, compliance items",
  },
  "external/06-post-close/counsel-annual-compliance-reminder": {
    id: "external/06-post-close/counsel-annual-compliance-reminder",
    name: "Counsel annual compliance reminder",
    path: "./external/06-post-close/counsel-annual-compliance-reminder.html",
    pipeline: "external",
    stage: "06-post-close",
    audience: ["counsel"],
    status: "exists",
    ...
    recurrenceRule: "annually",
    description:
      "Annual reminder: plan document amendments, regulatory updates, filing deadlines, diversification events",
  },
  "external/06-post-close/annual-benefit-statement-cover": {
    id: "external/06-post-close/annual-benefit-statement-cover",
    name: "Annual benefit statement cover letter",
    path: "./external/06-post-close/annual-benefit-statement-cover.html",
    pipeline: "external",
    stage: "06-post-close",
    audience: ["seller"],
    status: "exists",
    ...
    recurrenceRule: "annually",
    description:
      "Cover letter template for annual ESOP participant benefit statements — explains account growth and what the numbers mean",
  },
  "external/06-post-close/ownership-culture-workshop-guide": {
    id: "external/06-post-close/ownership-culture-workshop-guide",
    name: "Ownership culture workshop guide",
    path: "./external/06-post-close/ownership-culture-workshop-guide.html",
    pipeline: "external",
    stage: "06-post-close",
    audience: ["seller"],
    status: "exists",
    ...
    recurrenceRule: "quarterly",
    description:
      "Facilitator guide for quarterly ownership mindset workshops — discussion topics, activities, and follow-up",
  },
  ...
  "internal/05-closing/employee-communication-strategy-checklist": {
    id: "internal/05-closing/employee-communication-strategy-checklist",
    name: "Employee communication strategy checklist (internal)",
    path: "./internal/05-closing/employee-communication-strategy-checklist.html",
    pipeline: "internal",
    stage: "05-closing",
    audience: ["internal"],
    status: "exists",
    ...
    isRecurring: false,
    description:
      "Forhemit's internal checklist for planning, legal review, and executing employee communications around the ESOP announcement",
  },
  ...
  // ── Audience Coverage Gap Templates (#128–#142) ─────────────────────────────

  // CPA
  "external/03-engagement/cpa-engagement-confirmation": {
    id: "external/03-engagement/cpa-engagement-confirmation",
    name: "CPA engagement confirmation",
    path: "./external/03-engagement/cpa-engagement-confirmation.html",
    pipeline: "external",
    stage: "03-engagement",
    audience: ["cpa"],
    status: "exists",
    ...
    isRequired: true,
    isRecurring: false,
    description: "Confirms CPA role in ESOP transaction, §1042 coordination, QofE data requests, timeline",
  },
  "external/04-diligence/cpa-tax-coordination-update": {
    id: "external/04-diligence/cpa-tax-coordination-update",
    name: "CPA tax coordination update",
    ...
    isRecurring: true,
    recurrenceRule: "during-diligence",
    description: "Periodic update during diligence — QofE progress, tax election timing, document needs",
  },
  "external/06-post-close/cpa-post-close-tax-reminder": {
    id: "external/06-post-close/cpa-post-close-tax-reminder",
    name: "CPA post-close tax reminder",
    ...
    description: "Year-end reminder: ESOP plan tax returns, §1042 election deadline, contribution timing",
  },
  ...
  "external/06-post-close/broker-referral-nurture": {
    ...
    isRequired: false,
    isRecurring: false,
    description: "Anonymized closed-deal summary + testimonial request — reinforces referral relationship",
  },
  ...
  "external/06-post-close/seller-exit-interview": {
    ...
    isRequired: false,
    isRecurring: false,
    description: "Post-COOP feedback on entire process — what worked, what didn't, would they recommend",
  },

  // Trustee
  "internal/04-diligence/trustee-diligence-log": {
    id: "internal/04-diligence/trustee-diligence-log",
    name: "Trustee diligence log",
    path: "./internal/04-diligence/trustee-diligence-log.html",
    pipeline: "internal",
    stage: "04-diligence",
    audience: ["internal"],
    ...
    isRequired: false,
    isRecurring: false,
    description: "Documents fiduciary process — prudent steps taken, independence confirmed, decisions made",
  },
  "external/06-post-close/trustee-annual-review-agenda": {
    id: "external/06-post-close/trustee-annual-review-agenda",
    name: "Trustee annual review agenda",
    ...
    isRecurring: true,
    recurrenceRule: "annual",
    description: "Annual meeting agenda: repurchase obligation status, valuation update, plan health, compliance",
  },
  ...
  "external/04-diligence/counsel-legal-status-update": {
    ...
    isRequired: false,
    isRecurring: false,
    description: "Proactive request for document drafting status, open issues, timeline to Gate 4",
  },
  "external/06-post-close/counsel-annual-compliance-reminder": {
    id: "external/06-post-close/counsel-annual-compliance-reminder",
    name: "Counsel annual compliance reminder",
    ...
    isRecurring: true,
    recurrenceRule: "annual",
    description: "Annual reminder: plan document amendments, regulatory updates, filing deadlines",
  },

  // Employee (External — seller delivers to employees)
  "external/05-closing/manager-briefing-talking-points": {
    id: "external/05-closing/manager-briefing-talking-points",
    name: "Manager briefing talking points",
    path: "./external/05-closing/manager-briefing-talking-points.html",
    pipeline: "external",
    stage: "05-closing",
    audience: ["seller"],
    status: "exists",
    ...
    isRequired: false,
    isRecurring: false,
    description: "Pre-announcement Q&A guide for leadership team — handles common employee questions",
  },
  "external/05-closing/welcome-to-your-esop-booklet": {
    id: "external/05-closing/welcome-to-your-esop-booklet",
    name: "Welcome to Your ESOP booklet",
    path: "./external/05-closing/welcome-to-your-esop-booklet.html",
    pipeline: "external",
    stage: "05-closing",
    audience: ["seller"],
    status: "exists",
    ...
    isRequired: false,
    isRecurring: false,
    description: "Employee-facing leave-behind: ESOP basics, how accounts grow, distribution rules, what's next",
  },
  "external/06-post-close/annual-benefit-statement-cover": {
    id: "external/06-post-close/annual-benefit-statement-cover",
    name: "Annual benefit statement cover letter",
    ...
    isRecurring: true,
    recurrenceRule: "annual",
    description: "Cover letter template for annual ESOP participant statements — explains account growth",
  },
  "external/06-post-close/ownership-culture-workshop-guide": {
    id: "external/06-post-close/ownership-culture-workshop-guide",
    name: "Ownership culture workshop guide",
    ...
    isRecurring: true,
    recurrenceRule: "quarterly",
    description: "Facilitator guide for quarterly ownership mindset workshops — discussion topics, activities",
  },

  // Employee (Internal — Forhemit team processes)
  "internal/05-closing/employee-communication-strategy-checklist": {
    id: "internal/05-closing/employee-communication-strategy-checklist",
    name: "Employee communication strategy checklist",
    path: "./internal/05-closing/employee-communication-strategy-checklist.html",
    pipeline: "internal",
    stage: "05-closing",
    audience: ["internal"],
    ...
    isRequired: false,
    isRecurring: false,
    description: "Forhemit's internal checklist for planning, legal review, and executing employee comms",
  },
  "internal/06-post-close/employee-feedback-tracker": {
    id: "internal/06-post-close/employee-feedback-tracker",
    name: "Employee feedback tracker",
    path: "./internal/06-post-close/employee-feedback-tracker.html",
    pipeline: "internal",
    stage: "06-post-close",
    audience: ["internal"],
    status: "exists",
    ...
    isRecurring: true,
    recurrenceRule: "quarterly",
    description: "Tracks employee questions, concerns, sentiment from stewardship check-ins",
  },
};
