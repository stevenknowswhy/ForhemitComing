 ...
 */
function maybeSetUpTunnelRouteRewriteRules(
 ...
 */
function maybeCreateRouteManifest(
  incomingUserNextConfigObject,
  userSentryOptions,
) {
 ...
 */
function maybeSetClientTraceMetadataOption(
  incomingUserNextConfigObject,
  nextJsVersion,
) {
 ...
 */
function maybeSetInstrumentationHookOption(
  incomingUserNextConfigObject,
  nextJsVersion,
) {
...
function maybeGetVercelCronsConfig(userSentryOptions) {
  const result = { config: undefined, strategy: undefined };
...
export { filterRouteManifest, getNextMajor, maybeCreateRouteManifest, maybeGetVercelCronsConfig, maybeSetClientTraceMetadataOption, maybeSetInstrumentationHookOption, maybeSetUpTunnelRouteRewriteRules, resolveReleaseName, shouldReturnEarlyInExperimentalBuildMode, warnIfMissingOnRouterTransitionStartHook };
