 ...
 */
function moduleMetadataInjectionLoader(
  ...
  return userCode.replace(valueInjectionLoader.SKIP_COMMENT_AND_DIRECTIVE_REGEX, match => {
    return match + injectedCode;
  });
}

exports.default = moduleMetadataInjectionLoader;
