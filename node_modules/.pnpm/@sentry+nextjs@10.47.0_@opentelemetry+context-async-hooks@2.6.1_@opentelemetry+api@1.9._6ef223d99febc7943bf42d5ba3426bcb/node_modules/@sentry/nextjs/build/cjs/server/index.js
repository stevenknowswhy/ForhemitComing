...
const handleOnSpanStart = require('./handleOnSpanStart.js');
const prepareSafeIdGeneratorContext = require('./prepareSafeIdGeneratorContext.js');
...
function init(options) {
  ...
  client?.on('preprocessEvent', event => {
    ...
    if (
      ...
      event.contexts?.trace?.data?.[nextSpanAttributes.ATTR_NEXT_SPAN_TYPE] === 'BaseServer.handleRequest'
    ) {
