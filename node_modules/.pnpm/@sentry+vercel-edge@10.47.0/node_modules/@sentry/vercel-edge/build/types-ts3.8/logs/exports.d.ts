import { Log, ParameterizedString } from '@sentry/core';
/**
 ...
 * ```
 */
export declare function trace(message: ParameterizedString, attributes?: Log['attributes']): void;
/**
 ...
 * ```
 */
export declare function debug(message: ParameterizedString, attributes?: Log['attributes']): void;
/**
 ...
 * ```
 */
export declare function info(message: ParameterizedString, attributes?: Log['attributes']): void;
/**
 ...
 * ```
 */
export declare function warn(message: ParameterizedString, attributes?: Log['attributes']): void;
/**
 ...
 * ```
 */
export declare function error(message: ParameterizedString, attributes?: Log['attributes']): void;
/**
 ...
 * ```
 */
export declare function fatal(message: ParameterizedString, attributes?: Log['attributes']): void;
