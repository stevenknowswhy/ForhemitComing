					...
					<div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
						<div className="flex-1 pr-8 sm:pr-0">
							...
							<p className="text-white/70 text-sm">
								Download the complete framework and supporting materials
							</p>
						</div>
						...
						{!isSubmitted ? (
							<form
								...
								className="w-full md:w-auto space-y-3 md:space-y-0 md:flex md:items-center md:gap-3"
							>
								<input
									type="email"
								...
								<label className="flex items-center gap-2 text-sm text-white/70 cursor-pointer">
									...
									<span className="leading-tight">
										Have a specialist walk me through this
									</span>
								</label>
								<div className="flex items-center gap-3">
									<Button type="submit" variant="alert" size="md">
										Download
									</Button>
									<button
										type="button"
