			...
			<div className="calculator-results">
				<div className="result-item traditional">
					...
					<span className="result-note">
						After up to 23.8% federal capital gains
					</span>
				</div>
				...
				<section className="wealth-hero">
					<div className="container">
						<div className="wealth-hero-content">
							<span className="wealth-eyebrow" data-animate="fade-up">
								For Wealth Advisors
							</span>
							<h1
								className="wealth-title"
								data-animate="fade-up"
								data-delay="100"
							>
							...
							<p
								className="wealth-lead"
								data-animate="fade-up"
								data-delay="200"
							>
								When founders sell to traditional buyers, taxes destroy wealth
								and relationships evaporate. The ESOP alternative defers capital
								gains, multiplies your assets under management, and creates a
								legacy that endures.
							</p>
							<div
								className="wealth-hero-cta"
								data-animate="fade-up"
								data-delay="300"
							>
								<Link
					...
					<div className="container">
						<div className="section-header" data-animate="fade-up">
							...
							<p className="section-intro">
								When a successful business owner decides to sell, wealth
								managers face a crisis disguised as a celebration. The
								traditional path destroys more value than it creates.
							</p>
						</div>
						...
						<div className="warning-comparison" data-animate="fade-up">
							<div className="warning-path traditional">
								...
								<div className="path-consequence">
									...
									<span className="consequence-item">
										PE firm brings their own advisors
									</span>
									<span className="consequence-item">
										Relationship ends within 18 months
									</span>
								</div>
							</div>
							...
							<div className="warning-path esop">
								...
								<div className="path-benefits">
									...
									<span className="benefit-item">
										ESOP Trust management fees
									</span>
									<span className="benefit-item">
										Growing employee client base
									</span>
									<span className="benefit-item">
				...
				<section className="wealth-section benefits-section section-alt">
					<div className="container">
						<div className="section-header" data-animate="fade-up">
							...
							<p className="section-intro">
								An ESOP sale isn&apos;t just a transaction—it&apos;s structural
								tax arbitrage that requires your expertise at every turn.
							</p>
						</div>
				...
				<section className="wealth-section roles-section">
					<div className="container">
						<div className="section-header" data-animate="fade-up">
							...
							<p className="section-intro">
								We are operators and continuity engineers. You are the trusted
								confidant. Together, we engineer the most tax-efficient,
								wealth-generating transition possible.
							</p>
						</div>
						...
						<div className="reluctant-grid">
							<div className="reluctant-content" data-animate="slide-right">
								...
								<p className="reluctant-lead">
									You likely have clients past retirement age who refuse to
									sell. They fear that traditional private equity will strip
									their company, fire their loyal employees, and destroy the
									legacy they spent a lifetime building.
								</p>
								<p>
									We are the solution you can bring to them. By introducing the
									Forhemit model, you are no longer just asking about their
									retirement timeline—you are bringing a sophisticated
									structural solution.
								</p>
								...
								<div className="visual-overlay">
									<div className="overlay-stat">
										...
										<span className="overlay-label">
											of founders prefer legacy preservation over maximum price
										</span>
									</div>
								</div>
							</div>
					...
					<div className="container">
						<div className="cta-content" data-animate="fade-up">
							...
							<p className="cta-subtitle">
								You don&apos;t need to be an ESOP expert to present this
								option—that&apos;s what we&apos;re here for. If you have a
								client generating $3M–$15M in EBITDA who is concerned about
								taxes, employee welfare, and their legacy, let&apos;s talk.
							</p>
							...
							<div className="cta-options">
								<div className="cta-option primary" data-animate="slide-right">
									...
									<p>
										A confidential discussion about your client base and how we
										might work together.
									</p>
									<Link
								...
								<div className="cta-option secondary" data-animate="slide-left">
									...
									<p>
										A detailed guide for wealth managers on structuring
										Qualified Replacement Property portfolios.
									</p>
							...
							<div className="cta-contact" data-animate="fade-up">
								...
								<a href="mailto:advisors@forhemit.com" className="cta-email">
