...
export function ContactFormExperience({
	...
	const sendEmailNotification = useAction(
		api.emails.sendContactFormNotification,
	);
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			if (errorMessage.includes("Duplicate submission")) {
				showError(
					"You recently submitted a message. Please wait a moment before sending another.",
				);
			} else {
	...
	const layoutClassName =
		variant === "page"
			? "contact-modal-layout contact-page-layout"
				...
				<div className="contact-form-section">
					{revealedSection === "success" ? (
						<div className="contact-success">
							...
							<button
								className="form-btn form-btn-success-close"
								type="button"
						...
						<div className="form-preview-container">
							...
							<div className="form-review">
								...
								<div className="review-section review-section-message">
									...
									<span className="review-value review-message">
										{formData.message}
									</span>
								</div>
							</div>
						...
						>
							<div className="form-step-simple">
								...
								>
									...
									<option value="business-owner">
										Business Owner (ESOP Transition)
									</option>
									<option value="partner">
										Partner (Accounting, Legal, Lending, etc.)
									</option>
									<option value="existing-business">
										Existing Portfolio Business
									</option>
							...
							<div
								className={`form-step-simple reveal-section ${revealedSection !== "none" ? "revealed" : ""}`}
							>
								<div className="form-group form-group-full">
									...
									>
										...
										<option value="appraisal">
											Appraisal / Valuation Partnership
										</option>
							...
							<div
								className={`form-step-simple reveal-section ${revealedSection === "message" ? "revealed" : ""}`}
							>
								<div className="form-group form-group-full">
									<textarea
										id="contact-message"
