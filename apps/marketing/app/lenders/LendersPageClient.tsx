				...
				<section className="lenders-hero">
					<div className="container">
						<div className="lenders-hero-content">
							<span className="lenders-eyebrow" data-animate="fade-up">
								For Lending Institutions
							</span>
							<h1
								className="lenders-title"
							...
							<p
								className="lenders-lead"
								data-animate="fade-up"
								data-delay="200"
							>
								Secure your collateral with operational-level early warning
								systems that stop risk before it impacts your financials.
							</p>
							<div
								className="lenders-hero-cta"
								data-animate="fade-up"
								data-delay="300"
							>
								<Link
				...
				<section className="lenders-section pitch-section">
					<div className="container">
						<div className="section-header" data-animate="fade-up">
							<h2>
								The &quot;Friday at 3 PM vs. Tuesday Morning&quot; Scenario
							</h2>
						</div>
						...
						<div className="pitch-grid">
							...
							<div className="pitch-card crisis" data-animate="slide-left">
								...
								<div className="pitch-content">
									<span className="pitch-label crisis-label">
										The Status Quo
									</span>
									<h3>The Disease: Stage 4</h3>
									<p className="pitch-quote">
										&quot;Right now, in a traditional ESOP transition, how do
										you find out that a company is in trouble? You get a phone
										call on a Friday at 3:00 PM. The CEO tells you they are
										going to miss Monday&apos;s debt service payment.&quot;
									</p>
									<p className="pitch-detail">
										Why? Because you find out their CFO left 90 days ago, the
										accounting department has been flying blind, and cash flow
										has seized up. By the time you get that phone call, the
										damage is catastrophic. You aren&apos;t managing a
										transition; you are managing a crisis, and the loan is
										headed straight to the workout group.
									</p>
								</div>
							</div>
							...
							<div className="pitch-card solution" data-animate="slide-right">
								<div className="pitch-visual">
									<div className="solution-image">
										...
										<div className="solution-overlay">
											<span className="time-badge solution-time">
												Tue 9:00 AM
											</span>
										</div>
									</div>
								...
								<div className="pitch-content">
									<span className="pitch-label solution-label">
										The Forhemit Reality
									</span>
									<h3>The Early Diagnosis</h3>
									<p className="pitch-quote">
										&quot;With Forhemit&apos;s 24-month stewardship, that Friday
										afternoon call never happens. Instead, you get an update
										from us on a Tuesday morning, 48 hours after that CFO
										resigns.&quot;
									</p>
									<p className="pitch-detail">
										But it&apos;s not a panic call; it&apos;s a status report.
										We tell you: &quot;The CFO has departed. Per the COOP
										playbook we built prior to closing, the cross-trained
										Controller has already stepped in as interim CFO. The books
										are stable, a search firm was engaged yesterday, and there
										is zero threat to your debt service.&quot;
									</p>
								</div>
							</div>
						</div>
						...
						<div className="bottom-line" data-animate="fade-up">
							<div className="bottom-line-content">
								<span className="bottom-line-label">
									The Bottom Line: The Cure
								</span>
								<p>
									A fundamental principle holds true across business, medicine,
									and life:{" "}
									<strong>
										early engagement with a problem preserves the greatest
										number of solutions.
									</strong>{" "}
									Most lending models are reactive, triggered only when the
									event has impacted the balance sheet — this is frequently
									months after the cause.
								</p>
								<p style={{ marginTop: "1rem" }}>
									Forhemit engages at the operational level; we provide that
									critical advantage of an early warning system. We help you
									handle the situation at Stage One with easy to manage
									adjustments, rather than being forced to consider limited,
									high-stakes options at Stage Four.
								</p>
							</div>
						</div>
					</div>
					...
					<div className="container">
						<div className="section-header" data-animate="fade-up">
							...
							<p className="section-intro">
								SBA portfolio data consistently highlights a critical
								vulnerability: early defaults in acquisition financing are
								rarely caused by a flawed business model. They are driven by
								execution missteps, leadership vacuums, and sudden operational
								disruptions following a founder&apos;s exit.
							</p>
						</div>
						...
						<div className="threat-cards" data-animate="fade-up">
							<div className="threat-card">
								...
								<p>
									When the unexpected strikes during a transition, the business
									needs more than a financial model; it needs a tested
									operational playbook. We ensure backup systems activate within
									hours.
								</p>
							</div>
							<div className="threat-card">
								...
								<p>
									Critical vendors are notified through pre-established
									channels, and invoicing continues uninterrupted. The business
									keeps running even when leadership changes.
								</p>
							</div>
							<div className="threat-card">
								<span className="threat-icon">💰</span>
								...
								<p>
									Cash flow is protected, the system absorbs the shock, and the
									monthly payment is made on schedule. Your collateral remains
					...
					<div className="container">
						<div className="coop-grid">
							<div className="coop-content" data-animate="slide-right">
								...
								<h2 className="coop-title">
									Disaster-Tested Continuity of Operations (COOP)
								</h2>
								...
								<div className="coop-intro">
									...
									<p>
										Drawing on over a decade of experience leading disaster
										preparedness and response for the City and County of San
										Francisco, we apply specialized disciplines to protect your
										collateral.
									</p>
								</div>
								...
								<div className="coop-benefits">
									<div className="coop-benefit">
										...
										<div className="coop-benefit-content">
											...
											<p>
												We engineer operational continuity—not just financial
												restructuring
											</p>
										</div>
									</div>
									...
									<div className="coop-benefit">
										...
										<div className="coop-benefit-content">
											...
											<p>
												Pre-built operational frameworks for seamless
												transitions
											</p>
										</div>
									</div>
									...
									<div className="coop-benefit">
										...
										<div className="coop-benefit-content">
											...
											<p>
												Proactive protection ensuring your credit memo remains
												accurate
											</p>
										</div>
									</div>
										...
										<div className="coop-chart-overlay">
											<div className="mini-chart">
												<svg viewBox="0 0 100 40" className="chart-svg">
													<path
														d="M0,30 L20,25 L40,35 L60,20 L80,15 L100,10"
														stroke="var(--lenders-accent)"
														strokeWidth="2"
														fill="none"
													/>
													<circle
					...
					<div className="container">
						...
						<div className="coop-framework" data-animate="fade-up">
							...
							<p className="coop-subtitle">
								We recognize the shifting regulatory landscape and proactively
								structure every transaction to meet the most rigorous SBA
								eligibility and compliance mandates, ensuring a smooth path
								through LGPC submission.
							</p>
						</div>

						<div className="hardening-steps">
							<div
								className="harden-step"
								data-animate="fade-up"
								data-delay="0"
							>
								...
								<p>
									We conduct comprehensive citizenship and residency audits of
									all ESOP beneficiaries to ensure absolute compliance with
									Policy Notice 5000-876441. 100% Verification: We certify that
									all participants are U.S. Citizens or Nationals whose
									principal residence is in the U.S.
								</p>
							</div>
							...
							>
								...
								<p>
									The ESOP trust acquires 100% equity, easily satisfying the 51%
									requirement. All packages include an ERISA-compliant valuation
									report from an independent appraiser (Procedural Notice
									5000-872764) and legal opinions confirming trust compliance.
								</p>
							</div>
							...
							>
								...
								<p>
									We operate with absolute clarity regarding governance,
									strictly adhering to SBA Agent guidelines (SOP 50 10 7.1). We
									serve as specialized transition consultants for a strict
									90-day post-close period—the borrower's independent management
									team retains exclusive operational control.
								</p>
							</div>
						</div>
						...
						<div className="sop-alert" data-animate="fade-up">
							...
							<p className="sop-text">
								All compensation is a fixed, non-contingent advisory fee, fully
								disclosed on SBA Form 159. We provide no guarantees or
								keepwells; the borrower's creditworthiness is assessed on a
								standalone basis.
							</p>
						</div>
					</div>
						...
						<div className="benefits-grid">
							<div className="benefit-card" data-animate="slide-right">
								<div className="benefit-content">
									...
									<p>
										When the Debt Service Coverage Ratio drops below 1.25x
										trailing 3-month average, we trigger immediate board
										notification and advisory review of non-essential
										distributions. Proactive intervention prevents default.
									</p>
								</div>
							...
							<div className="benefit-card reverse" data-animate="slide-left">
								<div className="benefit-content">
									...
									<p>
										In the event of any verified compromise, we activate our
										COOP Incident Response protocol immediately. A written
										incident report is delivered to the Lender within 72 hours,
										with full remediation steps outlined.
									</p>
								</div>
								<div className="benefit-image">
									<img
							...
							<div className="benefit-card" data-animate="slide-right">
								<div className="benefit-content">
									...
									<p>
										Following funding, we implement a continuous monitoring and
										reporting framework during the critical transition period to
										provide lenders with unparalleled visibility into borrower
				...
				<section className="lenders-section how-section">
					<div className="container">
						<div className="section-header" data-animate="fade-up">
							...
							<p className="section-intro">
								Without structured transition oversight, leveraged ESOP
								transactions face elevated default exposure. We thoroughly
								mitigate this risk by delivering fully documented,
								underwriter-ready packages.
							</p>
						</div>
						...
						<div className="process-timeline">
							...
							>
								...
								<div className="step-card">
									<h3>Financials</h3>
									<p>
										3 years historical (tax-reconciled), 13-week post-close cash
										flow, and 5-year projections (including S-Corp tax benefits
										and ESOP contribution modeling).
									</p>
								</div>
							</div>
							...
							>
								...
								<div className="step-card">
									...
									<p>
										ESOP Beneficiary Citizenship Audit & Legal Certifications.
										Independent ERISA-Compliant Valuation, Equity Injection
										Verification, & Seller Standby Agreement (120 Months).
									</p>
								</div>
							</div>
							...
							>
								...
								<div className="step-card">
									...
									<p>
										The 90-Day Transition Blueprint, COOP Operational Playbook,
										Completed SBA Form 159, & Management Separation Affidavits.
										Everything an underwriter needs for confident approval.
									</p>
								</div>
							</div>
						</div>
						...
						<div
							className="five-d-content"
							data-animate="fade-up"
							style={{ marginTop: "4rem" }}
						>
							<div
								className="who-highlight"
								style={{ maxWidth: "800px", margin: "0 auto" }}
							>
								<span className="highlight-icon">💡</span>
								<p style={{ fontStyle: "italic", fontSize: "1.1rem" }}>
									&quot;The founder is not the business. We ensure the tenured
									leadership team has the independent capacity, cross-training,
									and operational authority to run the company
									successfully.&quot;
								</p>
							</div>
						</div>
					...
					<div className="container">
						<div className="cta-content" data-animate="fade-up">
							...
							<p className="cta-subtitle">
								The regulatory landscape is tightening. Your portfolio
								concentration is showing. The demographic cliff waits for no
								one. Partner with Forhemit to secure your collateral through
								proven operational continuity frameworks.
							</p>
							...
							<div className="cta-options">
								<div className="cta-option primary" data-animate="slide-right">
									...
									<p>
										Browse our comprehensive FAQ section covering lender
										partnerships, SBA compliance, risk mitigation strategies,
								...
								<div className="cta-option secondary" data-animate="slide-left">
									...
									<p>
										Speak directly with our stewardship experts to discuss your
										portfolio's succession risks and explore how our COOP
										framework can protect your SBA guaranty.
									</p>
									<Link
							...
							<div className="cta-contact" data-animate="fade-up">
								...
								<a href="mailto:info@forhemit.com" className="cta-email">
									info@forhemit.com
								</a>
							</div>
						</div>
