					...
					<div className="container">
						<div className="legal-text-content">
							...
							<p>
								...
								our website, fill out forms, or communicate with us. This may
								include:
							</p>
							<ul>
								<li>
								...
								<li>
									<strong>Professional Information:</strong> Resume, work
									history, and qualifications (for job applicants)
								</li>
								<li>
							...
							<ul>
								<li>
									Evaluate business opportunities and partnership inquiries
								</li>
								<li>
								...
								<li>
									Send SMS/text messages for appointment reminders, updates, and
									notifications (with your explicit consent)
								</li>
							...
							<p>
								...
								text messages, you expressly consent to receive SMS
								communications from Forhemit PBC in accordance with the
								Telephone Consumer Protection Act (TCPA).
							</p>
							<h3>Message Types and Frequency</h3>
							<ul>
								<li>
									<strong>Account Notifications:</strong> Updates about your
									inquiry or application status
								</li>
								<li>
									<strong>Appointment Reminders:</strong> Confirmation and
									reminder messages for scheduled calls or meetings
								</li>
								<li>
									<strong>Educational Content:</strong> Occasional ESOP
									resources and succession planning insights
								</li>
								<li>
									<strong>Customer Care:</strong> Responses to your inquiries
									and support requests
								</li>
							</ul>
							<p>
								Message frequency may vary based on your interactions with us.
								You may receive up to 10 messages per month depending on your
								engagement level and active business relationships.
							</p>
							<h3>Message and Data Rates</h3>
							<p>
								Message and data rates may apply depending on your mobile
								carrier and plan. Forhemit PBC is not responsible for any
								charges incurred from receiving text messages.
							</p>
							<h3>How to Opt Out</h3>
							<p>You can opt out of SMS communications at any time by:</p>
							<ul>
								<li>
							...
							<p>
								...
								message confirming your unsubscription. You will not receive any
								further marketing or promotional text messages unless you opt
								back in.
							</p>
							<h3>Help and Support</h3>
							<p>
								For help with SMS communications, reply <strong>HELP</strong> to
								any message or contact us at privacy@forhemit.com or call +1
								(800) 555-0199.
							</p>

							<h2>4. Email Communications (CAN-SPAM Compliance)</h2>
							<p>
								In accordance with the CAN-SPAM Act, all marketing emails from
								Forhemit PBC include:
							</p>
							<ul>
								<li>
									Clear identification that the message is an advertisement or
									promotional
								</li>
							...
							<p>
								...
								&quot;Unsubscribe&quot; link in any email or by updating your
								preferences on our
								<Link href="/opt-in">Communication Preferences</Link> page.
							</p>
							...
							<ul>
								...
								<li>
									...
									property, or safety, and that of our users
								</li>
							</ul>
							...
							<ul>
								...
								<li>
									Withdraw consent for marketing communications (email, SMS, or
									phone)
								</li>
								<li>
							...
							<p>
								...
								privacy@forhemit.com or call +1 (800) 555-0199.
							</p>
							...
							<p>
								<strong>Email:</strong> privacy@forhemit.com
								<br />
								<strong>Phone:</strong> +1 (800) 555-0199
								<br />
								<strong>Address:</strong> Forhemit PBC, Attn: Privacy Officer
								<br />
								<strong>Website:</strong>{" "}
								<Link href="/introduction">Contact Form</Link>
							</p>
						</div>
					</div>
				</section>
