...
function RevenueCalculator() {
	...
	const firstYearRevenue =
		portfolioSize * initialFee + portfolioSize * annualFee;
	const recurringRevenue = portfolioSize * annualFee;
	const fiveYearTotal =
		portfolioSize * initialFee + portfolioSize * annualFee * 5;

	return (
		<div
			ref={ref}
			className={`revenue-calculator ${isVisible ? "visible" : ""}`}
		>
			...
			<div className="calculator-results">
				<div className="result-item initial">
					...
					<span className="result-value">
						${((portfolioSize * initialFee) / 1000).toFixed(0)}k
					</span>
				...
				<div className="result-item recurring">
					...
					<span className="result-value">
						${(recurringRevenue / 1000).toFixed(0)}k
					</span>
				...
				<div className="result-item total">
					...
					<span className="result-value">
						${(fiveYearTotal / 1000).toFixed(0)}k
					</span>
				...
				<section className="appraisers-hero">
					<div className="container">
						<div className="appraisers-hero-content">
							<span className="appraisers-eyebrow" data-animate="fade-up">
								For Business Appraisers & Valuation Specialists
							</span>
							<h1
								className="appraisers-title"
								data-animate="fade-up"
								data-delay="100"
							>
								...
								<span className="highlight">
									Build a Book of Recurring Valuation Revenue.
								</span>
							</h1>
							<p
								className="appraisers-lead"
								data-animate="fade-up"
								data-delay="200"
							>
								Partner with Forhemit to transition $3M–$15M mid-market
								businesses to employee ownership— and turn one-off appraisals
								into mandated, annual engagements for the next decade.
							</p>
							<div
								className="appraisers-hero-cta"
								data-animate="fade-up"
								data-delay="300"
							>
								<Link
					...
					<div className="container">
						<div className="section-header" data-animate="fade-up">
							...
							<p className="section-intro">
								As a business appraiser, you know the grind of the traditional
								M&A lifecycle. You spend weeks digging deep, building complex
								models, defending your conclusions— and then you are back to
								zero.
							</p>
						</div>
						...
						<div className="problem-grid" data-animate="fade-up">
							<div className="problem-card">
								...
								<p>
									Once the business is sold to private equity or a strategic
									buyer, your job is done. The deep institutional knowledge you
									just built is essentially thrown away.
								</p>
							</div>
							<div className="problem-card">
								<span className="problem-icon">🏃</span>
								...
								<p>
									You are forced back onto the treadmill, hunting for the next
									founder, the next broker, or the next deal just to keep your
									revenue flowing.
								</p>
							</div>
							<div className="problem-card">
								...
								<p>
									You are trading your high-level expertise for one-time
									transactions, never building the predictable, recurring
									revenue that makes a practice truly valuable.
								</p>
							</div>
						</div>
					</div>
					...
					<div className="container">
						<div className="solution-grid">
							<div className="solution-content" data-animate="slide-right">
								<span className="appraisers-eyebrow">
									The Forhemit Solution
								</span>
								<h2>Valuation as an Annuity</h2>
								<p className="solution-lead">
									Forhemit is a California public benefit corporation that
									partners with founders to transition $3M–$15M businesses into
									100% Employee Stock Ownership Plans (ESOPs)—with long-term
									stewardship, not a quick flip.
								</p>
								<p>
									For an evaluation specialist, the ESOP model is the holy grail
									of valuation work. Why? Because it is a{" "}
									<strong>regulatory requirement</strong>. Under ERISA and
									Department of Labor (DOL) regulations, an ESOP trust must
									update the value of its privately held shares{" "}
									<strong>every single year</strong>.
								</p>
								<div className="solution-highlight">
									<span className="highlight-icon">💡</span>
									<p>
										When you value a Forhemit portfolio company, you aren't just
										pricing a transaction—you are onboarding a client for life.
									</p>
								</div>
							</div>
				...
				<section className="appraisers-section steps-section">
					<div className="container">
						<div className="section-header" data-animate="fade-up">
							...
							<p className="section-intro">
								We view our valuation partners not as vendors, but as critical,
								long-term infrastructure. Here is how working within the
								Forhemit ecosystem shifts your practice from a transactional
				...
				<section className="appraisers-section features-section section-alt">
					<div className="container">
						<div className="section-header" data-animate="fade-up">
							...
							<p className="section-intro">
								Valuation specialists often dread annual updates when the target
								company has messy books, high turnover, or erratic leadership.
								Forhemit eliminates this friction.
							</p>
						</div>
						...
						<div className="coop-highlight" data-animate="fade-up">
							...
							<p>
								Before we close a deal, our Chief Resilience Officer implements
								our proprietary
								<strong> Continuity of Operations (COOP) </strong>
								framework. We treat mid-market businesses like critical
								infrastructure—because to your valuation practice, they are.
							</p>
						</div>
					</div>
				</section>
					...
					<div className="container">
						<div className="cta-content" data-animate="fade-up">
							...
							<p className="cta-subtitle">
								If you are tired of the feast-or-famine cycle of traditional M&A
								and want to build a predictable, high-margin practice based on
								regulatory compliance, you need to be working in the ESOP space.
							</p>
							<p className="cta-lead">
								We are currently building our network of preferred, independent
								valuation specialists for our upcoming deal pipeline in the{" "}
								<strong>$3M–$15M EBITDA range</strong>.
							</p>
							...
							<div className="cta-options">
								<div className="cta-option primary" data-animate="slide-right">
									...
									<p>
										Discuss our current deal flow, timeline for upcoming initial
										appraisals, and how you can become the valuation partner of
										choice for the next generation of employee-owned businesses.
									</p>
									<Link
								...
								<div className="cta-option secondary" data-animate="slide-left">
									<h3>Learn More</h3>
									<p>
										Explore how our partnership program works and what it takes
										to become a preferred valuation partner in the Forhemit
										ecosystem.
									</p>
							...
							<div className="cta-contact" data-animate="fade-up">
								...
								<a href="mailto:appraisers@forhemit.com" className="cta-email">
