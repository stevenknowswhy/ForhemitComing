            ...
            <div className="solution-grid">
              <div className="solution-content" data-animate="slide-right">
                ...
                <p className="solution-lead">
                  Forhemit structures founder succession transactions for $3M-$15M businesses by
                  transitioning them into 100% Employee Stock Ownership Plans (ESOPs) with
                  continuity-focused stewardship support.
                </p>
                <p>
