...
interface DeleteConfirmModalProps {
  isOpen: boolean;
  onClose: () => void;
  entityId: Id<"contactSubmissions"> | Id<"jobApplications"> | Id<"earlyAccessSignups"> | Id<"phoneMessages"> | null;
  entityType: "contactSubmission" | "jobApplication" | "earlyAccessSignup" | "phoneMessage";
  entityName: string;
  onSuccess: () => void;
}
...
export default function DeleteConfirmModal({
  ...
  const deletePhoneMessage = useMutation(api.phoneMessages.deleteMessage);
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      } else if (entityType === "phoneMessage") {
        await deletePhoneMessage({ id: entityId as Id<"phoneMessages"> });
      } else {
