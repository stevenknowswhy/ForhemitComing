...
export function ContactModal({ isOpen, contact, onClose, onSave, onDelete }: ContactModalProps) {
  ...
  return (
    <>
      <div 
        className="fixed inset-0 bg-[#0E1C2F]/55 z-[200] flex items-start justify-center pt-10 overflow-y-auto"
        onClick={(e) => e.target === e.currentTarget && onClose()}
      >
        <div className="bg-white rounded-2xl w-full max-w-2xl mx-4 my-8 flex flex-col max-h-[calc(100vh-80px)]">
          {/* Header */}
