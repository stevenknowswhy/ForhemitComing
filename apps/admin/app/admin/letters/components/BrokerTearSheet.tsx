...
function EditableField({
	...
	return (
		<>
			...
			/>
			<span className="bts-print-value">{value || placeholder}</span>
		</>
	);
}
	...
	return (
		<div className="bts-container">
			...
			<div className="bts-app-header">
				<div>
					<div className="bts-app-wordmark">
						Forhemit Transition Stewardship
					</div>
				...
				<div className="bts-header-actions">
					{sendStatus && (
						<span
							className={`bts-status-message ${sendStatus.includes("success") ? "success" : sendStatus.includes("Failed") ? "error" : ""}`}
						>
							{sendStatus}
						</span>
					)}
					<button
						className="bts-btn-clear"
						onClick={handleClear}
						disabled={isSending}
					>
						Clear
						...
						<div className="bts-modal-body">
							...
							<div className="bts-preview-section">
								...
								<input
									...
									onChange={(e) =>
										setPreviewData((prev) => ({ ...prev, to: e.target.value }))
									}
									disabled={isSending}
								/>
							</div>
							...
							<div className="bts-preview-section bts-attachment-info">
								...
								{!pdfBase64 && (
									<span className="bts-attachment-warning">
			...
			<div className="bts-page">
				...
				<div className="bts-header">
					...
					<div style={{ textAlign: "right" }}>
						...
						<div className="bts-contact-line">
				...
				<div className="bts-body">
					...
					<div className="bts-col bts-col-left">
						<div>
							<div className="bts-headline">
								We help companies
								<br />
								<em>buy themselves.</em>
							</div>
							<div
								className="bts-sec-body"
								style={{
									marginTop: ".08in",
									color: "var(--bts-muted)",
									fontSize: "7.5pt",
							...
							>
								Forhemit is a transaction stewardship firm. We facilitate
								employee ownership transitions — coordinating the full deal
								team, managing the 120-day process, and staying on post-close to
								protect the seller&apos;s note and the continuity of the
								business.
							</div>
						</div>

						<div>
							<div className={SEC_LABEL}>Deal Criteria</div>
							<div className="bts-criteria-grid">
								<div className="bts-crit-label">EBITDA</div>
								<div className="bts-crit-val">
									<strong>$3M – $15M</strong>
								</div>
								<div className="bts-crit-label">Employees</div>
								<div className="bts-crit-val">
									<strong>20+</strong> W-2 employees
								</div>
								<div className="bts-crit-label">Entity</div>
								<div className="bts-crit-val">
									C-corp preferred; S-corp considered (conversion req.)
								</div>
								...
								<div className="bts-crit-val">
									<strong>FL, TX, TN</strong> — other states considered
								</div>
								<div className="bts-crit-label">Seller</div>
								<div className="bts-crit-val">
									Founder-led, 3+ yr consistent financials, exit in 1–3 yrs
								</div>
								<div className="bts-crit-label">Workforce</div>
								<div className="bts-crit-val">
									All ESOP participants: U.S. citizens or permanent residents
								</div>
							</div>
						</div>

						<div>
							<div className={SEC_LABEL}>How We Close</div>
							<div className="bts-steps">
								<div className="bts-step">
									<div className="bts-step-num">1</div>
									<div className="bts-step-text">
										<strong>Pre-Qualification</strong>Deal screened, lender
										engaged, team identified before the seller signs anything.
									</div>
								</div>
								<div className="bts-step">
									<div className="bts-step-num">2</div>
									<div className="bts-step-text">
										<strong>Team Assembly</strong>lender, ESOP trustee, ERISA
										counsel, TPA, and appraiser — pre-vetted, coordinated by
										Forhemit.
									</div>
								</div>
								<div className="bts-step">
									...
									<div className="bts-step-text">
										<strong>120-Day Process</strong>Five phases with hard gates.
										The owner runs the business. We run the deal.
									</div>
								</div>
								<div className="bts-step">
									<div className="bts-step-num">4</div>
									<div className="bts-step-text">
										<strong>Post-Close Stewardship</strong>12–24 months of
										operational monitoring protects the seller&apos;s note and
										the transition.
									</div>
								</div>
							</div>
						...
						<div>
							<div className={SEC_LABEL}>What We Bring</div>
							<div className="bts-diff-list">
								<div className="bts-diff-item">
									<div className="bts-diff-dot"></div>
									<div className="bts-diff-text">
										<strong>Pre-positioned deal team.</strong> Trustee, lender,
										and counsel identified before the LOI — no discovery
								...
								<div className="bts-diff-item">
									<div className="bts-diff-dot"></div>
									<div className="bts-diff-text">
										<strong>COOP pre-assessment.</strong> Key-person and
										operational risk documented before close — the single
										biggest lender and trustee concern on ESOP deals.
									</div>
								</div>
								<div className="bts-diff-item">
									<div className="bts-diff-dot"></div>
									<div className="bts-diff-text">
										<strong>Transaction vs. transition.</strong> A conventional
										buyer closes in 120 days with a loan. We close in 120 days
										with a fully documented, operationally stable transition.
									</div>
								</div>
							</div>
						</div>
						...
						<div>
							<div className={SEC_LABEL}>Send Us a Deal</div>
							<div className="bts-sec-body">
								Email a teaser or NDA-protected CIM to{" "}
								<strong
									style={{ fontFamily: "var(--bts-ff-m)", fontSize: "7pt" }}
								>
									deals@forhemit.com
								</strong>
								. We confirm fit within 48 hours. No commitment required for the
								first conversation.
							</div>
						</div>
					</div>
					...
					<div className="bts-col bts-col-mid">
						<div>
							<div className={SEC_LABEL}>$3M EBITDA Deal — The Real Math</div>
							<table className="bts-deal-table">
								...
								<tbody>
									...
									<tr>
										...
										<td
											className="bts-esop-col"
											style={{ color: "var(--bts-red)" }}
										>
											− $675,000
										</td>
									</tr>
									...
									<tr className="bts-tax-row">
										...
										<td>− $4,069,800</td>
										<td className="bts-esop-col">
											$0 &nbsp;
											<span
												style={{
													fontSize: "6pt",
													fontFamily: "var(--bts-ff-b)",
												}}
											>
												§1042
											</span>
									...
									<tr className="bts-note-row">
										<td colSpan={3}>
											PE wins by only $205,200 after tax — on a $4,500,000
							...
							<div
								className="bts-table-footnote"
								style={{
									marginTop: "0.08in",
									background: "rgba(154,117,64,0.07)",
									borderLeft: "2px solid var(--bts-brass)",
									padding: "0.07in 0.1in",
									fontStyle: "normal",
									color: "var(--bts-ink)",
								}}
							>
								That $205K PE advantage assumes the seller collects every dollar
								as stated. PE deals at this size typically include{" "}
								<strong style={{ color: "var(--bts-navy)" }}>
									earn-outs tied to post-close performance and restrictive
									covenants
								</strong>{" "}
								lasting 2–5 years. The Forhemit seller note carries{" "}
								<strong style={{ color: "var(--bts-navy)" }}>
									no earn-outs, no performance conditions, and no restrictive
									covenants
								</strong>{" "}
								— a fixed obligation with a mandatory refinance trigger.{" "}
								<em style={{ color: "var(--bts-muted)" }}>
									The PE number is a ceiling. The ESOP number is a floor.
								</em>
							</div>
							<div
								className="bts-table-footnote"
								style={{ marginTop: "0.05in" }}
							>
								FL domicile, C-corp, zero cost basis, full §1042 election. ESOP
								proceeds: ~$10.1M cash at close + ~$3.4M seller note (mandatory
								refinance trigger Mo. 14–18). Forhemit&apos;s fee is paid by the
								ESOP trust — not a line item here or on the seller&apos;s
								closing statement. Seller&apos;s CPA must model actual basis and
								§1042 eligibility.
							</div>
						</div>

						<div>
							<div className={SEC_LABEL}>The Closing Statement</div>
							<div className="bts-callout">
								<strong>
									Forhemit does not appear as a line item on the seller&apos;s
									closing statement.
								</strong>{" "}
								Our fee is paid by the ESOP trust — the buyer entity — as a
								tax-deductible business expense. The seller receives their full
								negotiated purchase price. The broker receives their full
								commission from proceeds. Neither number is adjusted, reduced,
								or deferred by our engagement.
							</div>
						</div>

						<div>
							<div className={SEC_LABEL}>Side by Side</div>
							<table className="bts-deal-table">
								<thead>
									<tr>
										<th></th>
					...
					<div className="bts-col bts-col-right">
						<div>
							<div className={SEC_LABEL}>Who Gets Paid What</div>
							<div className="bts-closing-stmt">
								<div className="bts-closing-title">
									Compensation — All Three Parties
								</div>
								<div className="bts-fee-row">
									<div className="bts-fee-who bts-broker">Broker</div>
									<div className="bts-fee-detail">
										<strong>Full commission at closing from proceeds.</strong>{" "}
										Same rate as any other buyer. We do not renegotiate, defer,
										or share your fee. Existing agreements with the seller are
										honored.
									</div>
								</div>
								<div className="bts-fee-row">
									...
									<div className="bts-fee-detail">
										<strong>Full negotiated purchase price.</strong> ~75% cash
										at close; ~25% seller note. §1042 defers federal cap gains.
										Forhemit&apos;s fee does not appear on the closing statement
										— the seller&apos;s number is the seller&apos;s number.
									</div>
								</div>
								<div className="bts-fee-row">
									<div className="bts-fee-who bts-forhemit">Forhemit</div>
									<div className="bts-fee-detail">
										<strong>Paid by the ESOP trust</strong> — the buyer entity —
										as a tax-deductible business expense. Structuring retainer
										($25K, earned at engagement) + transaction fee at close. We
										do not take equity. We are never the buyer.
									</div>
								</div>
							</div>
						</div>
						...
						<div>
							...
							<div className="bts-gotcha-box">
								...
								<div className="bts-gotcha-list">
									<div className="bts-gotcha-item">
										S-corp sellers must convert to C-corp before closing for
										§1042 to apply — flag this at intake, before any conversion
										happens.
									</div>
									<div className="bts-gotcha-item">
										Cash at close is ~75% of price. The seller note carries the
										balance with a mandatory refinance trigger at Mo. 14–18.
									</div>
									<div className="bts-gotcha-item">
										Timeline can extend to 150–180 days for licensing, landlord
										consents, or successor hiring. This is not a failure state.
									</div>
									<div className="bts-gotcha-item">
										All ESOP participants must be U.S. citizens or permanent
										residents — confirm workforce at intake.
									</div>
									<div className="bts-gotcha-item">
										Forhemit is completing its first transaction. Our credential
										is a pre-positioned team and lender-validated process
										structure, not a closed deal count.
									</div>
								</div>
							</div>
						</div>
						...
						<div>
							<div className={SEC_LABEL}>Running a Parallel Buyer Process?</div>
							<div
								className="bts-sec-body"
								style={{
									color: "var(--bts-muted)",
							...
							>
								We are two-track friendly. If you&apos;re also showing the deal
								to conventional buyers, ask us for our two-track cost analysis.
								One critical flag:{" "}
								<strong style={{ color: "var(--bts-ink)" }}>
									an S-corp that converts to C-corp and then sells
									conventionally faces Built-In Gains tax exposure.
								</strong>{" "}
								That conversation belongs with the seller&apos;s CPA before
						...
						<div
							style={{
								marginTop: "auto",
								paddingTop: ".09in",
								borderTop: "1px solid var(--bts-rule)",
							}}
						>
							<div
								className="bts-sec-body"
							...
							>
								Tax figures assume C-corp, zero basis, full §1042 election,
								Florida domicile. §1042 requires reinvestment in Qualified
								Replacement Property within 12 months. This is not tax or legal
								advice. Seller&apos;s CPA must confirm eligibility and model
								actual exposure.
							</div>
						</div>
					</div>
