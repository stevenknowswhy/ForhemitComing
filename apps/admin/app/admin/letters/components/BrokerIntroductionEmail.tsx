...
function EditableField({
	...
	return (
		<>
			...
			/>
			<span className="bie-print-value">{value || placeholder}</span>
		</>
	);
}
...
export default function BrokerIntroductionEmail() {
	...
	const sendBrokerEmail = useAction(
		api.brokerEmails.sendBrokerIntroductionEmail,
	);
		...
		if (checked && !introPdfBase64) {
          ...
          <div style="font-family: 'Cormorant Garamond', Georgia, serif; background: #F8F5EF; color: #1C1510; margin: 0; padding: 0;">
            ...
            <div style="padding: 0.8rem 2.8rem 0.5rem; font-size: 0.9rem; line-height: 1.65; color: #1C1510;">
              ...
              <div style="margin-bottom: 0.8rem;">Forhemit Transition Stewardship coordinates the full deal team — lender, ESOP trustee, ERISA counsel, TPA, and appraiser. We manage the process from intake through closing across a structured 120-day timeline. The owner runs the business. We run the deal.</div>
            ...
            <div style="border-top: 1px solid #D4CBBF; padding: 1.2rem 2.8rem 1.4rem; background: #EDE8DF;">
              <div style="font-family: 'Cormorant Garamond', Georgia, serif; font-size: 1.1rem; font-weight: 400; color: #1A2238; margin-bottom: 0.2rem;">${formData.senderFirstName} ${formData.senderLastName}</div>
		...
		if (checked && !tearSheetPdfBase64) {
          ...
          <div class="bts-page" style="font-family: Georgia, serif; background: #F8F5EF; padding: 0.4in; width: 8.5in; min-height: 11in; box-sizing: border-box; color: #1A2238;">
                ...
                <div>
                  ...
                  <div style="display: flex; flex-direction: column; gap: 0.1in;">
                    ...
                    <div style="display: flex; gap: 0.08in;">
                      ...
                      <div style="font-size: 7.5pt; line-height: 1.4;"><strong>Team Assembly</strong><br/><span style="color: #6F6A63;">lender, trustee, ERISA counsel, TPA.</span></div>
                    </div>
                    <div style="display: flex; gap: 0.08in;">
            ...
            <div style="margin-top: 0.2in; padding-top: 0.15in; border-top: 1px solid #D4CBBF; display: flex; justify-content: space-between; font-size: 7pt; color: #6F6A63;">
              <div>${formData.senderFirstName} ${formData.senderLastName} · ${formData.senderTitle}</div>
	...
	const handleSendEmail = async () => {
		...
		try {
			const payload = {
				...
				...(attachTearSheetPdf && tearSheetPdfBase64
					? { tearSheetPdfBase64 }
					: {}),
			};
	...
	return (
		<div className="bie-container">
			...
			<div className="bie-app-header">
				<div>
					<div className="bie-app-wordmark">
						Forhemit Transition Stewardship
					</div>
					<div className="bie-app-sub">
						Broker Introduction Email — Fillable Form
					</div>
				</div>
				<div className="bie-header-actions">
					{sendStatus && (
						<span
							className={`bie-status-message ${sendStatus.includes("success") ? "success" : sendStatus.includes("Failed") ? "error" : ""}`}
						>
							{sendStatus}
						</span>
					)}
					<button
						className="bie-btn-clear"
						onClick={handleClear}
						disabled={isSending}
					>
						Clear
			...
			{showPreview && (
				<div
					className="bie-modal-overlay"
					onClick={() => !isSending && setShowPreview(false)}
				>
					<div
						className="bie-modal-content bie-modal-large"
					...
					>
									...
									<span className="bie-toggle-text">
										{generatingIntro ? (
											...
											<>
												📄 Introduction Letter
												{introPdfBase64 && (
													<span className="bie-file-name">
														{" "}
														(Forhemit-Broker-Introduction.pdf) ✓
													</span>
												)}
											</>
										)}
										...
										{generatingTearSheet ? (
											...
											<>
												...
												{tearSheetPdfBase64 && (
													<span className="bie-file-name">
														{" "}
														(Forhemit-Broker-Tear-Sheet.pdf) ✓
													</span>
												)}
											</>
										)}
						...
						<div className="bie-modal-footer">
							...
							>
								{isSending
									? "Sending..."
									: generatingIntro || generatingTearSheet
										? "Generating PDFs..."
										: "✉ Send Email"}
							</button>
						</div>
			...
			<div className="bie-paper">
				...
				<div className="bie-email-wrap">
					<div className="bie-email-body">
						...
						<div className="bie-para">
							<strong>I'll keep this short.</strong> Forhemit Transition
							Stewardship is actively looking for founder-owned businesses to
							acquire, and brokers are how we find them. I want to introduce us,
							tell you exactly what we're looking for, and be direct about how
							everyone gets paid.
						</div>
						...
						<div className="bie-para">
							...
							seller exits at fair market value. The employees become the
							owners. The business stays in the community it was built in.
						</div>
						...
						<ul className="bie-bullet-list">
							...
							<li>
								Founder-led, consistent 3+ year financial history, exit in 1–3
								years
							</li>
						</ul>
						...
						<div className="bie-para">
							...
							it anyway — we confirm fit within 48 hours and give you a clear
							yes or no.
						</div>
						...
						<ul className="bie-bullet-list">
							<li>
								Fully vetted partners (Lenders, Trustees, ERISA Counsel) ready
								to go
							</li>
						...
						<div className="bie-pay-grid">
							<div className="bie-pay-block bie-broker">
								...
								<div className="bie-pay-detail">
									Your commission is paid at closing from proceeds — same rate
									as any other buyer. We do not renegotiate, defer, or share
									your fee. Existing agreements with the seller are honored.
								</div>
							</div>
							...
							<div className="bie-pay-block bie-forhemit">
								<div className="bie-pay-who bie-forhemit">
									Forhemit Transition Stewardship
								</div>
								<div className="bie-pay-detail">
									We are paid by the ESOP trust — the buyer entity — as a{" "}
									<strong>tax-deductible business expense</strong>. A
									structuring retainer ($25,000, earned at engagement) plus a
									transaction fee at closing. We do not take equity. We are
									never the buyer. We do not appear on anyone's closing
									statement.
								</div>
							</div>
						</div>
						...
						>
							The headline number will be at fair market value, not a PE
							premium. Here is what the comparison looks like after tax:
						</div>
							...
							<table className="bie-deal-table">
								...
								<tbody>
									...
									<tr>
										...
										<td
											className="bie-esop-col"
											style={{ color: "var(--bie-red)" }}
										>
											− $675,000
										</td>
									</tr>
						...
						<div className="bie-callout" style={{ marginTop: "0.7rem" }}>
							<p>
								...
								include{" "}
								<strong>earn-outs tied to post-close performance</strong> and{" "}
								<strong>restrictive covenants</strong> that constrain the seller
								for 2–5 years. The Forhemit seller note carries{" "}
								<strong>
						...
						<div className="bie-para">
							...
							lender, ESOP trustee, ERISA counsel, TPA, and appraiser. We manage
							the process from intake through closing across a structured
						...
						<div className="bie-callout">
							<p>
								<strong>
									Forhemit does not appear as a line item in the seller's
									closing documents.
								</strong>{" "}
				...
				<div className="bie-sig-block">
					<div className="bie-sig-name">
						<EditableField
							...
							onChange={(v) => updateField("senderFirstName", v)}
							placeholder="First name"
							className="bie-sender-name"
						/>
						<EditableField
							value={formData.senderLastName}
							onChange={(v) => updateField("senderLastName", v)}
							placeholder="Last name"
							className="bie-sender-name"
						/>
					</div>
