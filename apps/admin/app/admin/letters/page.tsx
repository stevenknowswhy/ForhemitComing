...
import ClientIntroductionLetter from "./components/ClientIntroductionLetter";
import PreliminaryReviewLetter from "./components/PreliminaryReviewLetter";
import QuickSendEngagementLetter from "./components/QuickSendEngagementLetter";
...
const letterTemplates: LetterTemplate[] = [
	{
		...
		description:
			"Generate professional introduction letters for prospects, partners, and stakeholders",
	...
	},
	{
		...
		description:
			"Email template for introducing Forhemit to business brokers with deal structure and economics",
		category: "Brokers",
		status: "active",
		version: "1.0",
	...
	},
	{
		...
		description:
			"One-page tear sheet with deal criteria, economics, and process overview — sent as PDF",
		category: "Brokers",
		status: "active",
		version: "1.0",
	...
	},
	{
		...
		description:
			"Warm first-contact letter for clients — explains what Forhemit does, how the process works, and why it matters. Sent before the Intro Call.",
		category: "Clients",
		status: "active",
		version: "1.0",
	...
	},
	{
		...
		name: "Preliminary Review Letter",
		description:
			"Assessment letter with initial valuation perspective, fee structure, and how Forhemit is paid. Sent after initial conversations.",
		category: "Clients",
		status: "active",
		version: "1.0",
		component: PreliminaryReviewLetter,
	},
	{
		id: "engagement-letter",
		name: "Engagement Letter — Quick Send",
		description:
			"Generate and send the ESOP engagement letter. Auto-fills from CRM data, supports preview, email, Box Sign, and save-to-Box workflows.",
		category: "Contracts",
		status: "active",
		version: "3.0",
		component: QuickSendEngagementLetter,
	},
];
				...
				{letterTemplates.map((letter) => (
					<div key={letter.id} className="template-card">
						<div className="template-card-header">
							...
							<div
								className={`template-card-status template-status-${letter.status}`}
							>
								{letter.status}
							</div>
						</div>
