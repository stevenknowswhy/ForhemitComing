...
function FilterItem({
	...
	return (
        ...
        ${active ? "bg-orange-50 text-orange-900 dark:bg-orange-950/30 dark:text-orange-300" : "text-[var(--text2)] hover:bg-[var(--surface2)] hover:text-[var(--text)]"}
      `}
		>
			<span className="flex items-center gap-2">
				...
				<span style={{ color: !active && labelColor ? labelColor : undefined }}>
					{label}
				</span>
			</span>
			{count !== undefined && (
				<span
					className={`text-[10px] px-1.5 py-0.5 rounded-full ${
						active
							? "bg-orange-100 text-orange-900 dark:bg-orange-950/40 dark:text-orange-300"
