...
function CalendarDay({
	...
	return (
        ...
        ${isToday ? "border-orange-500 bg-orange-50 dark:border-orange-400 dark:bg-orange-950/30" : "border-[var(--border)] bg-[var(--surface)] hover:border-[var(--border2)]"}
      `}
		>
			<div
				className={`text-xs sm:text-sm font-semibold mb-1 sm:mb-2 ${isToday ? "text-orange-800 dark:text-orange-300" : "text-[var(--text)]"}`}
			>
				{day}
			</div>
			...
			<div className="flex flex-col gap-1">
				{companies.map((company) => {
					...
					if (days !== null && days < 0)
						borderLeftColor = "var(--red)"; // Overdue
