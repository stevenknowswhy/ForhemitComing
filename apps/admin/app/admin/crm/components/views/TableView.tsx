...
import type { Company, SortConfig } from "@forhemit/shared/features/crm";
import { StageBadge, NdaBadge, DueDateTag, AdvisorChip } from "../shared";
import {
	formatDate,
	getRelativeDate,
	truncateText,
	...
	if (companies.length === 0) {
		return (
			<div className="flex flex-col items-center justify-center h-[400px] max-[375px]:h-[min(45vh,300px)] px-4 text-[var(--text3)] text-center">
				...
				<h3 className="text-lg text-[var(--text)] mb-2 font-semibold">
					No companies found
				</h3>
