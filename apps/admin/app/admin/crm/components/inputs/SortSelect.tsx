	...
	const mobileSheet =
		...
		createPortal(
			<>
				...
				>
					<div
						className="mx-auto mb-2 h-1 w-10 shrink-0 rounded-full bg-[var(--border2)]"
						aria-hidden
					/>
								...
								<li key={opt.value} role="presentation">
									<button
										...
										className={cn(
											...
											selected &&
												"bg-orange-50 font-medium text-orange-900 dark:bg-orange-950/30 dark:text-orange-300",
										)}
										onClick={() => {
											onChange(opt.value);
											setOpen(false);
		...
		<div className="relative min-w-0 flex-1 lg:flex-initial lg:max-w-none">
			...
			<div className="relative lg:hidden">
				<button
					...
					className={cn(
						...
						"bg-[var(--surface)] px-3 py-2 text-left text-[12px] text-[var(--text2)]",
			...
			<select
				...
				className={cn(
					...
					"px-3 py-2 text-[12px] text-[var(--text2)]",
