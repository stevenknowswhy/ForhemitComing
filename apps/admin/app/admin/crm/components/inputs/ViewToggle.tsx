...
import type { CrmView } from "@forhemit/shared/features/crm";
			...
			{VIEWS.map((view) => {
				...
				return (
					<button
						...
						className={`
              flex items-center gap-1.5 max-[375px]:gap-1 px-2.5 max-[375px]:px-2 sm:px-3 py-1.5 max-[375px]:py-1 rounded text-[11px] max-[375px]:text-[10px] shrink-0
              transition-all min-h-[36px] max-[375px]:min-h-[32px]
              ${
								isActive
									? "bg-orange-50 text-orange-900 dark:bg-orange-950/30 dark:text-orange-300 shadow-sm"
