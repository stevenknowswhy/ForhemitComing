  ...
  return (
    <div className="pkg-output-container">
      <div className="pkg-output-header">
        <div className="pkg-output-brand">FORHEMIT TRANSITION STEWARDSHIP CO.</div>
      ...
      <div className="pkg-output-section">
        ...
        <p>
          <strong>Forhemit Transition Stewardship Co.</strong> is a Public Benefit
      ...
      <div className="pkg-output-contact">
        ...
        <p>
          ...
          <br />
          Founder, Forhemit Transition Stewardship Co.
          <br />
