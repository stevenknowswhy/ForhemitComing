...
export function generateCreditMemo(options: CreditMemoOptions): string {
  ...
  const lines: string[] = [
    ...
    "Prepared by Forhemit Transition Stewardship Co. — Transaction Manager & Post-Close Stewardship Provider",
    ...
    "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
    "  Forhemit Transition Stewardship Co. is a California Public Benefit Corporation.",
