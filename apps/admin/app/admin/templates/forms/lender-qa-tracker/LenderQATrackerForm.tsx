...
const LenderQATrackerForm = forwardRef<
	TemplateFormHandle,
...
>(function LenderQATrackerForm({ initialData }, ref) {
	...
	const editingItem =
		editingItemIndex !== null ? inputs.items[editingItemIndex] : null;
				...
				{currentStep === 1 && (
					<>
						...
						<div className="lqa-form-nav">
							<div />
							<button
								className="lqa-btn lqa-btn-primary"
				...
				{currentStep === 2 && (
					<>
						...
						<div className="lqa-data-actions">
							<button
								className="lqa-btn lqa-btn-secondary"
