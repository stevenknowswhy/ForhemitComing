...
export const gallerySlides: GallerySlide[] = [
  ...
  },
  {
    ...
    subtitle: "We believe AI should be a tool for augmentation, not a reason for displacement. In the coming shift, the only way to ensure technology benefits people is to make people the owners of the technology. By converting businesses to employee ownership, we ensure that when efficiency increases, wealth stays with workers rather than being extracted.\n\n[Download PDF: The AI Perfect Storm: Why Ownership is the Ultimate Hedge]",
    accent: "The Standard",
  },
  {
    id: "investor-thesis",
